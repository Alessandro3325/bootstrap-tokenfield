  ...
  , keydown: function (e) {
      ...
      switch(e.keyCode) {
        ...
        case 13: // enter
          ...
          if (this.$input.data('ui-autocomplete') && this.$input.data('ui-autocomplete').menu.element.find("li:has(div.ui-state-active), li:has(a.ui-state-focus), li.ui-state-focus").length) break
